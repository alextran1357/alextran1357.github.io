...
- [E-commerce Revenue Analytics]({{ '/projects/ecommerce-revenue-analysis/' | relative_url }}) — modeled 1.9 million order items, identified product and seasonal concentration risks, and built a forecast with approximately 15–18% MAPE.
- [Steam Game Pricing Intelligence]({{ '/projects/steam-game-pricing/' | relative_url }}) — collected more than 460,000 price events and published an interactive benchmarking dashboard.
- [California Real Estate Data Pipeline]({{ '/projects/mls-real-estate-pipeline/' | relative_url }}) — built a repeatable cleaning, enrichment, feature-engineering, and outlier workflow for hundreds of thousands of MLS records.
